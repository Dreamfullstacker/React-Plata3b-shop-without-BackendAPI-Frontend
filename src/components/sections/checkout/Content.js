                    ...
                    <form method="post">
                        <div className="row">
                            <div className="col-xl-7">
                                ...
                                <Accordion>
                                    <div className="andro_notice">
                                        <p>Are you a returning customer?
                                         <Accordion.Toggle as={NavLink} variant="link" eventKey="0" className="p-0">Click here to login</Accordion.Toggle>
                                        </p>
                                    </div>
                                    <Accordion.Collapse eventKey="0">
                                        <div className="andro_notice-content d-block">
                                            <div className="row">
                                                <div className="col-xl-6 form-group">
                                                    <label>Email Address</label>
                                                    <input type="text" className="form-control" name="login-email" placeholder="Email Address" />
                                                </div>
                                                <div className="col-xl-6 form-group">
                                                    <label>Password</label>
                                                    <input type="password" className="form-control" name="login-pass" placeholder="Password" />
                                                </div>
                                    ...
                                    {/* Coupon Code */}
                                    <div className="andro_notice">
                                        <p>Do you have a coupon code?
                                        <Accordion.Toggle as={NavLink} variant="link" eventKey="1" className="p-0">Click here to Apply</Accordion.Toggle>
                                        </p>
                                    </div>
                                        ...
                                        <div className="andro_notice-content d-block">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <div className="input-group-append">
                                                    <button className="andro_btn-custom shadow-none" type="button">Apply Code</button>
                                                </div>
                                            </div>
                                        </div>
                                    </Accordion.Collapse>
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-xl-12">
                                        ...
                                        <input type="text" placeholder="Company Name (Optional)" name="cname" className="form-control" />
                                    </div>
                                    <div className="form-group col-xl-12">
                                    ...
                                    <div className="form-group col-xl-6">
                                        ...
                                        <input type="text" placeholder="Street Address One" name="addr-1" className="form-control" required />
                                    </div>
                                    <div className="form-group col-xl-6">
                                        <label>Street Address 2</label>
                                        <input type="text" placeholder="Street Address Two (Optional)" name="addr-1" className="form-control" />
                                    </div>
                                    <div className="form-group col-xl-12">
                                        <label>Town / City <span className="text-danger">*</span></label>
                                        <input type="text" placeholder="Town/City" name="town" className="form-control" required />
                                    </div>
                                    <div className="form-group col-xl-6">
                                    ...
                                    <div className="form-group col-xl-12 mb-0">
                                        ...
                                        <textarea name="name" rows={5} className="form-control" placeholder="Order Notes (Optional)" />
                                    </div>
                                </div>
                                {/* Buyer Info End */}
                            </div>
                            <div className="col-xl-5 checkout-billing">
                                                ...
                                                <td data-title="Product">
                                                    <div className="andro_cart-product-wrapper">
                                                        <div className="andro_cart-product-body">
                                                            <h6> <Link to="#">{item.productname}</Link> </h6>
                                ...
                                <button type="submit" className="andro_btn-custom primary btn-block">Place Order</button>
                                {/* Order Details End */}
                            </div>
                        </div>
                    </form>
